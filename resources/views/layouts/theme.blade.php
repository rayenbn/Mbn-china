...
<title>{{ $global_settings->meta_title ?? "" }}</title>
    ...
    <!-- bootstrap grid css -->
    <link rel="stylesheet" href="{{ asset('theme/css/plugins/bootstrap-grid.css')}}">
    <!-- font awesome css -->
    <link rel="stylesheet" href="{{ asset('theme/css/plugins/font-awesome.min.css')}}">
    <!-- swiper css -->
    <link rel="stylesheet" href="{{ asset('theme/css/plugins/swiper.min.css')}}">
    <!-- fancybox css -->
    <link rel="stylesheet" href="{{ asset('theme/css/plugins/fancybox.min.css')}}">
    <!-- ashley scss -->
...
<body>
	<div id="app">
			...
			<div class="mil-preloader">
				<div class="mil-preloader-animation">
					<div class="mil-pos-abs mil-animation-1">
						<p class="mil-h3 mil-muted mil-thin">Shipping</p>
						<p class="mil-h3 mil-muted">Sourcing</p>
						<p class="mil-h3 mil-muted mil-thin">Marketing</p>
					</div>
					<div class="mil-pos-abs mil-animation-2">
						<div class="mil-reveal-frame">
							<p class="mil-reveal-box"></p>
							<p class="mil-h3 mil-muted mil-thin">mbn.com</p>
						</div>
					</div>
				</div>
			</div>
        ...
        <div class="mil-frame">
            <div class="mil-frame-top">
                <a href="home-1.html" class="mil-logo">MBN.</a>
    ...
    <!-- swup js -->
    <script src="{{ asset('theme/js/plugins/swup.min.js')}}"></script>
    <!-- swiper js -->
    <script src="{{ asset('theme/js/plugins/swiper.min.js')}}"></script>
    <!-- fancybox js -->
    <script src="{{ asset('theme/js/plugins/fancybox.min.js')}}"></script>
    <!-- gsap js -->
    <script src="{{ asset('theme/js/plugins/gsap.min.js')}}"></script>
    <!-- scroll smoother -->
    <script src="{{ asset('theme/js/plugins/smooth-scroll.js')}}"></script>
    <!-- scroll trigger js -->
    <script src="{{ asset('theme/js/plugins/ScrollTrigger.min.js')}}"></script>
    <!-- scroll to js -->
    <script src="{{ asset('theme/js/plugins/ScrollTo.min.js')}}"></script>
    <!-- ashley js -->
